...
resource "aws_iam_role" "lambda-exec-get" {
  name = "product-get-lambda"
...
resource "aws_iam_role" "s3_policy_edit_role" {
  name = "s3_policy_edit_role"
